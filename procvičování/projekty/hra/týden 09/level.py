...
class Level:
    def __init__(self, level_data, screen, sprite_groups):
        ...
        # pro každou položku z dictionary sprite_groups vytvoř self.nazev_groupy attribut v této classe
        ...
        # spusť funkci init_items() při vytvoření classy        
        self.init_items()
    ...
    # vytvoř různé předměty pomocí loopu z funkce create_items
    def init_items(self):
    ...
    def create_items(self, layer, item_class, group):
        # pro každý předmět ve v dostazené vrstvě z .tmx souboru vytvoř instanci classy a následně ji přidej do skupiny
        for item in layer:
